  ...
  return (
    <section id="ritual" className="relative px-6 py-40">
      <Reveal className="mx-auto max-w-3xl text-center">
        ...
        <p className="mx-auto mt-7 max-w-xl opacity-70">
      ...
      <footer className="mx-auto mt-32 max-w-7xl border-t border-current/10 pt-10 text-center text-xs uppercase tracking-[0.3em] opacity-50">
